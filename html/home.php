                ...
                <nav class="navbar navbar-expand-lg navbar-light py-3 px-lg-0"><a class="navbar-brand" href="index.html"><span class="fw-bold text-uppercase text-dark">Bouge</span></a>
                  ...
                  <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto">
                      ...
                      <li class="nav-item">
                        <!-- Link--><a class="nav-link" href="catalog.html">Catalog</a>
                      </li>
                      <li class="nav-item">
                        <!-- Link--><a class="nav-link" href="feed.html">My Feed</a>
                      </li>
                      <li class="nav-item">
                        <!-- Link--><a class="nav-link" href="profile.html">My Closet</a>
                      </li>
            ...
            for ($x = 0; $x <= count($prodArray); $x++) {
                echo '<div class="col-lg-4 col-sm-6">
                    <div class="product text-center">
                      ...
                      <h6> <a class="reset-anchor" href="detail.html">'.$prodArray['prod'.$x]['name'].'</a></h6>
